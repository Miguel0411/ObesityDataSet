...
Este código crea una tabla DatosObesidad con las columnas y 
tipos de datos especificados, utilizando nvarchar y float según 
corresponda, con las longitudes y precisiones dadas. Si necesitas más
ajustes o datos adicionales, házmelo saber.